...
{
      14,     0,    -1,    15,    -1,    16,    17,    18,    -1,    -1,
       7,    10,    -1,     7,    11,    -1,     7,    12,    -1,    -1,
       8,     3,    -1,    -1,     9,     3,    -1
};
...
{
  "$end", "error", "$undefined", "NUMERO", "INTEGER", "STRING", "DOUBLE",
  "NGH", "CELLS", "TICKS", "'NEUMANN'", "'MOORE'", "'EXTENDED'", "$accept",
  "programa", "header", "neighbourhood", "n_cells", "time", 0
};
#endif
...
{
       5,     6,     7,     1,     8,     9,    11,    12,    14
};

static const yytype_uint8 yycheck[] =
{
      10,    11,    12,     7,     0,     8,     3,     9,     3
};
  ...
  switch (yyn)
    {
        case 2:
#line 50 "compiler.y"
    { sprintf(temp, "%s fin", (yyvsp[(1) - (1)].cadena));
                                                 printf("%s\n", temp);;}
    break;

  case 3:
#line 58 "compiler.y"
    { sprintf(temp, "%s %s %s", (yyvsp[(1) - (3)].cadena), (yyvsp[(2) - (3)].cadena), (yyvsp[(3) - (3)].cadena));
                                                 printf("%s\n", temp);;}
    break;

  case 4:
#line 64 "compiler.y"
    {sprintf (temp, "ngh NEUMANN\n");
                                            (yyval.cadena) = genera_cadena (temp);  ;}
    break;

  case 5:
#line 66 "compiler.y"
    {sprintf (temp, "%s %s\n", (yyvsp[(1) - (2)].cadena), (yyvsp[(2) - (2)]));
                                           (yyval.cadena) = genera_csadena (temp);  ;}
    break;
...
#line 70 "compiler.y"
  ...
  case 8:
#line 74 "compiler.y"
    { sprintf (temp, "cells 500\n");
                                        (yyval.cadena) = genera_cadena (temp);  ;}
    break;

  case 9:
#line 76 "compiler.y"
    { sprintf (temp, "%s %d\n", (yyvsp[(1) - (2)].cadena), (yyvsp[(2) - (2)].valor));
                                        (yyval.cadena) = genera_cadena (temp); ;}
    break;

  case 10:
#line 80 "compiler.y"
    { sprintf (temp, "ticks 500\n");
                                        (yyval.cadena) = genera_cadena (temp); ;}
    break;
